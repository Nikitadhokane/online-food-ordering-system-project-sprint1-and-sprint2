...
//	@PostMapping("/login")
//	public String validateUser(@RequestBody Customer cust) throws ServletException
//	{
//		String jwtToken="";
//		
//		if(cust.getUserid()==null || cust.getPwd()==null)
//		{
...
//		
//        cust=customerService.validate(userId, password);
//		
//		if(cust==null)
//		{
...
//		
//		
//		jwtToken=Jwts.builder().setSubject(userId).claim("userId", cust.getUserid()).
